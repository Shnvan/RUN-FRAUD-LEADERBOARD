...
export function AdminSignIn({initialEmail="",authenticated=false}:{initialEmail?:string;authenticated?:boolean}){
  ...
  return <main className="mx-auto grid min-h-[65dvh] max-w-[1240px] place-items-center px-5 py-16 md:px-8"><div className="retro-window retro-window--plum w-full max-w-md bg-card p-6 sm:p-8">
