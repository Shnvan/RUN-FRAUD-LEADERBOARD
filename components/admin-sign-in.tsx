...
export function AdminSignIn({initialEmail="",authenticated=false}:{initialEmail?:string;authenticated?:boolean}){
  ...
  return <main className="mx-auto grid min-h-[65dvh] max-w-[1240px] place-items-center px-5 py-16 md:px-8"><div className="w-full max-w-md border border-foreground/20 bg-card p-6 sm:p-8">
    <p className="font-mono text-[10px] uppercase tracking-[.16em] text-muted-foreground">Private workspace</p><h1 className="mt-3 text-4xl font-semibold tracking-[-.07em]">Admin sign in</h1><p className="mt-3 text-sm leading-6 text-muted-foreground">Password and an authenticator code are required. Public account creation is disabled.</p>
