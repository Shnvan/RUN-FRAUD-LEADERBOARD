  ...
  return <div className="min-h-screen overflow-x-clip">
    ...
    <header className="site-header relative z-40 border-b-[3px] border-[var(--ink)] bg-[var(--signal)] text-white">
      <div className="mx-auto flex max-w-[1480px] flex-wrap items-center gap-2 px-4 py-2 md:px-8">
        ...
        <span className="hidden border-l border-white/30 pl-3 font-[family-name:var(--font-pixel)] text-[10px] lg:inline">BUYER REPORT ARCHIVE / PHP</span>
        ...
        <div className="ml-auto flex items-center gap-2 md:ml-1"><ThemeToggle/><RecordTrigger label="Report unresolved loss" compactLabel="Report" className="archive-button archive-button--red shrink-0 px-2 text-[10px] sm:px-3"/></div>
      </div>
    </header>
    {children}
